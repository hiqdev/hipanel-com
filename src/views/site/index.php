    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">Open for integration and extension</h3>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <h4 class="service-heading">SaaS and Open Source</h4>
                <p class="text-muted">Choose what you prefer. Nothing to install cloud based SaaS solution. Or open source solution installed at your side.</p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                ...
                <h4 class="service-heading">Responsive Design and Friendly UX</h4>
                <p class="text-muted">Modern and responsive design. Nice to look on every device. Easy to use for every task.</p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                ...
                <h4 class="service-heading">Security and reliability</h4>
                <p class="text-muted">OAuth2, ABAC, Backup and more ...</p>
            </div>
        </div>
    </div>
</section>
